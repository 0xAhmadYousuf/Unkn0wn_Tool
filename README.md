...
## **07 CMS FIND BY REQUESTS RESPONCE TEXT**
...
## **10 DOMAIN / SUB-DOMAIN EXTRACTOR**
...
**`This Tool is for cracking vps by information list from input file and saving them to an output file. Here's some future of this Tool`**
...
## **28 WORDPRESS XMLRPC EXPLOIET**

**`This Progarm is for performing xmlrpc attack on fetched user's information from WordPress websites. The advantage of this function are as follows`**
